        ...
        <div class="arrivedtickets" >
            ...
            <div class="content-section">
                <div class="date-container">
                    <h2 class="sectionh2">Pending Tickets</h2>
                    <form id="dateRangeForm" action="<?php echo base_url('index.php/PendingDate'); ?>" method="POST">
                            ...
                            <?php if (!empty($tickets)): ?>
                                <?php foreach ($tickets as $ticket): ?>
                                    <tr>
                                        ...
                                        <td>
                                        <a href="<?php echo base_url('index.php/ClosePending/' . $ticket['ticket_id']); ?>" class="filter-btn">close</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
